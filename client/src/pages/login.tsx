      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-white mb-2 title-glow">
            Welcome to S&P Capital IQ
          </h1>
          <p className="text-gray-300 text-sm">
            Credentials are only used to authenticate to S&P Capital IQ. All saved data will be stored in your database.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" data-testid="login-form">
          ...
          <div className="flex items-start space-x-2 text-xs text-gray-400">
            ...
            <label htmlFor="terms">
              I agree to the{" "}
              <span className="text-accent-cyan hover:underline cursor-pointer">Terms of service</span>
              {" "}and{" "}
              <span className="text-accent-cyan hover:underline cursor-pointer">Privacy policies</span>
              {" "}of S&P Capital IQ Corporation
            </label>
          </div>
