  ...
  return (
    <nav className="w-full py-4 sm:py-6 px-4 sm:px-6 md:px-8 lg:px-16 animate-shift-down" data-testid="navigation">
      <div className="flex justify-between items-center">
        ...
        <Button
          onClick={handleLogin}
          className="bg-accent-cyan text-primary-dark px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 rounded-full font-semibold sm:text-base md:text-lg hover:bg-white button-glow transition-all duration-300 text-[15px]"
